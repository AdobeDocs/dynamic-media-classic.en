...
level: Experienced
TQID: https://experienceleague.adobe.com/1FyA0Zm9Kp8E-kTtyVcGAjGEkQtjjI1bCm2-rT1AMCw
product_v2:
...
When you create an Offer Set, the **[!UICONTROL Publish after a save]** option affects the set and set members in the following ways:
...
1. When you finish editing, near the lower-right corner of the page, ensure that **[!UICONTROL Publish after a save]** is selected (default).
