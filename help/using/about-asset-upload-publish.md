...
---
# Upload and publish assets {#about-uploading-and-publishing-assets}

Adobe Dynamic Media Classic includes three basic functions:

* Uploading file assets to Adobe Dynamic Media Classic.
* Managing your files so you can use them to create rich-media assets.
* Publishing your asset files to a Dynamic Media Classic server so that they are available for delivery to your website and applications.
