...
You can automate set generation as an independent job that is not dependent on an upload.
...
1. In the Generate Set dialog box, specify a job name.
   ...
   By default, the job is assigned a name that indicates it is a generated job and the time when the job was generated.
