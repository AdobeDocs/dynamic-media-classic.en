...
Adobe Dynamic Media Classic comes with several "best practice" Image Presets that are already set up for you to use. Administrators can create Image Presets as well. To create an Image Preset, you can create a new one or you can start from an existing one and save it under a new name.
...
You can create your own Image Presets if you are a Company Administrator. You can create Image Presets or use a default Image Preset that Adobe Dynamic Media Classic provides, edit it, and save it with a new name.

**To create an Image Preset:**

1. Go to **[!UICONTROL Setup]** > **[!UICONTROL Image Presets]**.

   To preview an existing Image Preset, you can browse to an Image Preset name on this screen. When you select an Image Preset name, the sample image in the Preview window changes size and appearance.

1. Do one of the following:

   * **Create an Image Preset**: Select **[!UICONTROL Add]**.
   * **Edit an Image Preset**: Browse to the Image Preset that is most similar to the one you want to create and then select **[!UICONTROL Edit]**.
...
To delete an Image Preset, select it on the Image Presets screen, and then select **[!UICONTROL Delete]**.
