...
* **Grid View**: In the upper-right of the Adobe Dynamic Media Classic screen, select the **[!UICONTROL Grid View]** icon to see assets as thumbnails in a grid. To change the size of the thumbnail images in Grid View, drag the Thumbnail slider.

* **List View**: Near the upper-right corner of the Adobe Dynamic Media Classic screen, select the **[!UICONTROL List View]** icon to see assets in a list. The list tells you the name, type, creation date, and last modification date of each asset. Depending on the type of asset with which you are working, additional information is available. For example, you can see the dimensions and file size of an image.
...
>[!TIP]
>
>You can select a default view for the Browse panel and customize the panel settings. See [Personal Setup](personal-setup.md#personal_setup).
