...
* [How Adobe Dynamic Media Classic Supports SEO](/help/using/assets/s7_seo.pdf): Adobe Dynamic Media Classic optimizes images for search engines to increase traffic to your website. This PDF provides the background and implementation guidance to achieve that result.
...
* [Best practices to deliver interactive experiences with Adobe Dynamic Media Classic](https://seminars.adobeconnect.com/p7wb8ej3u6d/): This webinar teaches you how to import and export content with Adobe Dynamic Media Classic. Learn how to set up Image Presets for optimal performance and experience. You also learn about Viewer Presets and caching configurations.
