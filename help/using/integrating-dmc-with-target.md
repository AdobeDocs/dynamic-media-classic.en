...
Before you can integrate [!DNL Adobe Dynamic Media Classic] with [!DNL Target Standard/Premium], you must enter your Target URL on the [!DNL Adobe Dynamic Media Classic] Application General Settings screen. To obtain your Target URL and enter it in the Application General Settings page, do the following

1. In [!DNL Adobe Experience Cloud], sign in to your [!DNL Target Standard/Premium] account.
1. After you sign in, in your browser's address bar, copy the URL up to and including `.com`.

   If the URL (URL paths always contain forward slashes, not backslashes) in the address bar is `https://www.myfictionalsite.com/categories/admin/home.do`, copy this part: `https://www.myfictionalsite.com`.
