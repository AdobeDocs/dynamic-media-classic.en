...
level: Intermediate
TQID: https://experienceleague.adobe.com/fc4baWSHA-JTzKrbJ99foBQglqqO7fAMlkqJPJQAVzw
product_v2:
...
After you publish an Image Set, you can copy its associated URL or its embed code for use in your Web site or application. Then you can deploy the URL or paste the embedded code as necessary so users can view the Image Set on your Web site or application.
...
1. Above the Asset Browse panel, on the right side of the toolbar, do one of the following:
    ...
    * Select **[!UICONTROL Grid View]**. In the Asset Browse panel, double-click a single asset to open it in Detail View. In the **[!UICONTROL URLs and Embed Code]** panel on the right, select **[!UICONTROL Copy URL]** to the right of the viewer you want.
...
## Copy the embedded code of an Image Set viewer {#copying-the-embed-code-of-an-image-set-viewer}

Using the embedded code feature lets you review the viewer code for the selected Image Set. You can also copy the code to the clipboard so you can paste it in your Web pages for deployment of the viewer. Editing of the code is not permitted in the Embed Code dialog box.

**To copy the embedded code of an Image Set viewer:**

1. In the Asset Browse panel, in the Show drop-down list, select **[!UICONTROL Image Set]**.
1. in the Asset Library panel on the left side, navigate to the asset folder that contains the Image Set whose embedded code you want to copy.
1. Above the Asset Browse panel, on the right side of the toolbar, do one of the following:
...
1. In the **[!UICONTROL Embed Code]** dialog box, select **[!UICONTROL Copy to Clipboard]**.

   Editing the code is not permitted in the **[!UICONTROL Embed Code]** dialog box.
