...
You can map unknown locales to specific IDs or to generic IDs. For the example, you can map unknown locales to the English IDs, or if they do not exist, to the generic IDs.
